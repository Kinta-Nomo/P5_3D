...
function draw(){
      ...
      for (var j = 0; j < arranged[i][0].length-1; j++){
        ...
        // if (bearing < PI/4 && bearing > -PI/4){
          ...
          if (arranged[i][0][j][2] > rotationOrigin[2]+screenDepth){
            ...
            // vertex((arranged[i][0][j][0] - rotationOrigin[0])*m, -(arranged[i][0][j][1] - rotationOrigin[1])*m);
    ...
    stroke(255)
    line(-500,-rotationOrigin[2]-screenDepth, 500,-rotationOrigin[2]-screenDepth)
    for (var i = 1; i < arranged.length; i++){
      
      stroke(255)
      point(rotationOrigin[0], rotationOrigin[2])
      for (var j = 0; j < arranged[i][0].length-1; j++){
        //projecting 3d point onto 2d plane
        bearing = Math.atan((arranged[i][0][j][0]-rotationOrigin[0])/(arranged[i][0][j][2]-rotationOrigin[2]))
        
        stroke(255)
        line(rotationOrigin[0], -rotationOrigin[2], arranged[i][0][j][0], -arranged[i][0][j][2])
